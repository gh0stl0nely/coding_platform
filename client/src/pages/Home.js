    ...
    return (
        <Container style={{ marginTop: "80px" }}>
            <Grid container justify="center">
                <Grid item style={{ height: "250px",textAlign: "center", backgroundColor: "#80A7E3", borderRadius: "20px" }} xs={12} md={6}>
                    <h1 className="animate__animated animate__flipInX">App name</h1>
                    <p className="animate__animated animate__lightSpeedInLeft">Introduction paragaraph</p>
                </Grid>
                <Grid className="animate__animated animate__backInDown" item style={{ textAlign: "center", padding:"30px 10px 10px 10px" }} xs={12} md={6}>
