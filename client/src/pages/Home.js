        ...
        <Container style={{ marginTop: "80px" }}>
            <Grid container justify="center">
                <Grid item style={{ height: "250px", textAlign: "center", backgroundColor: "#142850", borderRadius: "20px", marginTop: "10px" }} xs={12} md={6}>
                    ...
                    <p className="animate__animated animate__lightSpeedInLeft animate__delay-1s" style={{ fontFamily: 'Lobster', fontSize: "35px", color: "white" }}>Your Go-to platform for preparing coding interview</p>
                </Grid>
