...
import Demo from "../components/Programmeow.gif";
    ...
    return (
        <Container style={{ marginTop: "80px" }}>
            <Grid container justify="center">
                <Grid item style={{ height: "250px", textAlign: "center", backgroundColor: "#142850", borderRadius: "20px", marginTop: "10px" }} xs={12} md={6}>
                    <h1 className="animate__animated animate__flipInX" style={{ fontFamily: 'Lobster', fontSize: "40px", color: "white", marginBottom: '10px' }}>Programmeow</h1>
                    <p className="animate__animated animate__lightSpeedInLeft animate__delay-1s" style={{ fontFamily: 'Lobster', fontSize: "35px", color: "white", padding: '20px', marginTop: '10px' }}>Your Go-to platform for coding interview preparation</p>
                </Grid>
                <Grid className="animate__animated animate__backInDown" item style={{ textAlign: "center", paddingLeft: "10px", paddingTop: "20px" }} xs={12} md={6}>
                ...
                <Grid item style={{ textAlign: "center", marginTop: "20px", backgroundColor: "#4482C2", color: "white", fontSize: "20px", borderRadius: "20px" }} xs={12}>
                    <p>Currently the website only support JavaScript.</p>
                    <p>We will be continuously updating our website to support more programming languages.</p>
                </Grid>
                <Grid item style={{ textAlign: "center", marginTop: "20px", borderRadius: "20px"}} xs={12} md={7}>
                    <ScrollAnimation animateIn="animate__slideInLeft">
                    <iframe style={{width: '90%', borderRadius:'10px'}} src="https://drive.google.com/file/d/1VZUArTorBuE8Y1OsejgZqN2Q30mJ8wsA/preview" height="350"></iframe>
                    </ScrollAnimation>
                </Grid>
                <Grid item style={{ textAlign: "center", marginTop: "20px", borderRadius: "20px" }} xs={12} md={5}>
                    <ScrollAnimation animateIn="animate__bounceInDown">
                        <p style={{ fontFamily: 'Lobster', fontSize: "40px", color: "#142850", marginBottom: "10px" }}>Practice Question Demo</p><VideocamIcon style={{ fontSize: 100, color: "#142850" }} />
                    </ScrollAnimation>
                </Grid>
            </Grid>
            <Cards />
            <Grid container style={{ paddingBottom: "30px", backgroundColor: "#1D4D80", textAlign: "center" }}>
                ...
                <Grid item xs={12}>
                    ...
                    <Button onClick={() => window.location.href = "/signup"} size="large" variant="contained" style={{ backgroundColor: "#142850", color: "white", fontSize: "25px" }}>
                        sign up
                        </Button>
                    <ScrollAnimation animateIn="animate__flash" style={{ display: "inline-block" }}>
